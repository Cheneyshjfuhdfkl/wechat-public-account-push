export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxf2be97c4008329d3",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "0ccaaa067983ff64cc7ed11fc35a85f5",
  ...
  USERS: [
    {
      ...
      id: "oKU2C6sl3qaqpYtrgb6_awX5Csbc",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "9H6hU4O99SD9lE2ZULtgp9ivcHXKNuebSL9C32ckJyo",
      // 所在省份
      province: "甘肃",
      // 所在城市
      city: "兰州",
